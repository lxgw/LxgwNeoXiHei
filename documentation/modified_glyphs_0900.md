...
本表中所收录的字即「霞鹜新晰黑」v0.900 所包含的字，包含《通用规范汉字表》、《现代汉语通用字表》、GB/T 2312-80 收录的汉字（GB/T 2312-80 中收录的繁体字「麴」除外）以及未被以上三表收录的化学元素中文名称、常用偏旁等，按 Unicode 码位排序。v0.235 版本收录的其余汉字在 v0.900 中暂时剔除，待后续整理后重新加入。
...
> ㊟　酉部右下角若靠近撇或横，则右下砍脚；若右下角旁为竖，或为撇、横但不靠近，则右下加脚。
