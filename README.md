...
本字体尝试在[「IPAex黑体」](https://ipafont.ipa.go.jp)和[「霞鹜传承晰黑」](https://github.com/lxgw/LxgwClearGothic)（已归档）原有字形的基础上，将其改造成中国大陆规范字形；简化了一些部件的出脚（如「枸」「间」「陶」「岩」等字中「口」「日」「缶」「山」部件的出脚），使字形更加简洁。除此之外，重做了希腊字母和西里尔字母，与原字体拉丁字母部分风格基本一致，更适合现代希腊文及西里尔文的排版；新增对越南语拉丁字的显示支持。
...
- [x] [外字初步整理表](https://github.com/lxgw/LxgwNeoXiHei/blob/main/documentation/ext_characters_preliminary.md) 所含字对应繁体字（采用 [BabelPad](https://www.babelstone.co.uk/Software/BabelPad.html) 转换）；
