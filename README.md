...
- [ ] [外字初步整理表](https://github.com/lxgw/LxgwNeoXiHei/blob/main/documentation/ext_characters_preliminary.md) 所含字对应繁体字（采用 [BabelPad](https://www.babelstone.co.uk/Software/BabelPad.html) 转换）；
